...
ActiveRecord::Schema.define(version: 20170403093825) do
  ...
  create_table "favorite_lists", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["micropost_id"], name: "index_favorite_lists_on_micropost_id", using: :btree
    t.index ["user_id", "micropost_id"], name: "index_favorite_lists_on_user_id_and_micropost_id", unique: true, using: :btree
  ...
  add_foreign_key "favorite_lists", "microposts"
